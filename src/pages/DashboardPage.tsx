  ...
  return (
    <div className="flex">
            ...
            <ul className="space-y-2">
              {recentChats.map((chat, index) => (
                <li key={index}>
                  <Link 
                    to="/chat"
                    className="sidebar-item flex items-center p-2 text-gray-600 hover:bg-gray-50 rounded-lg w-full text-left transition-colors"
                  >
                    <i className="fas fa-comment-dots text-blue-500 mr-3"></i>
                    <span className="text-sm">{chat.name}</span>
                  </Link>
      ...
      <div className="flex-1 p-8">
        ...
        {/* Chat Interface Link */}
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <h2 className="text-xl font-bold text-gray-800 mb-4">AI Document Assistant</h2>
          <p className="text-gray-600 mb-4">
            Start a conversation with our AI assistant about your documents. Get detailed explanations, 
            risk assessments, and plain-language interpretations.
          </p>
          <Link 
            to="/chat" 
